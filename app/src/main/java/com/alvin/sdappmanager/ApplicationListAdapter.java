 ...
 * @browse http://myandroidsolutions.blogspot.com/2012/08/android-expandable-list-example.html
 *
 */
...
public class ApplicationListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<Application> mParent;
    private ExpandableListView accordion;
    public int lastExpandedGroupPosition;


    public ApplicationListAdapter(Context context, ArrayList<Application> parent, ExpandableListView accordion) {
        mParent = parent;
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.app_item_parent, viewGroup,false);
        }
        ...
        if (mParent.get(i).sys) textView.setTextColor(Color.RED);
        else                    textView.setTextColor(Color.BLACK);

        imageView.setImageDrawable(mParent.get(i).icon);

        TextView sub = (TextView) view.findViewById(R.id.list_item_text_subscriptions);

        sub.setText(mParent.get(i).getSize());
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = inflater.inflate(R.layout.app_item_child, viewGroup,false);
        }

        CheckedTextView textView = (CheckedTextView) view.findViewById(R.id.list_item_text_child);
        TextView textView2 = (TextView)  view.findViewById(R.id.list_item_size_child);

        //"i" is the position of the parent/group in the list and
        //"i1" is the position of the child
        textView.setText(mParent.get(i).children.get(i1).name);
        textView2.setText(mParent.get(i).children.get(i1).getSize());
